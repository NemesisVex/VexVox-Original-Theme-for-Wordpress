		...
		<header>
			<div class="span-14 last source-label">
				...
				<div class="span-1 last">
					<a class="entry-format" href="<?php echo esc_url( get_post_format_link( 'image' ) ); ?>" title="<?php echo get_post_format_string( 'image' ); ?>"><span class="genericon genericon-image" /></a>
				</div>
			</div>
			<div class="span-4">
