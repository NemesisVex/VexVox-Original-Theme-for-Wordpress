		...
		<header>
			<div class="span-14 last source-label">
				...
				<div class="span-1 last">
					<a class="entry-format" href="<?php echo esc_url( get_post_format_link( 'quote' ) ); ?>" title="<?php echo get_post_format_string( 'quote' ); ?>"><span class="genericon genericon-quote" /></a>
				</div>
			</div>
			<div class="span-4">
